...
public class CustomDialogClassSorting extends Dialog implements
    ...
    public CustomDialogClassSorting(Activity a) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_dialog_sorting);
